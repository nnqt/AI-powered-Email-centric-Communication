\section{Cơ sở công nghệ và lựa chọn Tech stack}
\label{sec:TechStack}

\subsection{Frontend stack: Next.js (React) và TypeScript}
...
\subsection{Backend orchestration: Next.js API Routes và mô hình microservice}
...
\subsection{Cơ sở dữ liệu: NoSQL và MongoDB cho dữ liệu Email bán cấu trúc}
...
\subsection{Cache/Queue: Redis cho PoC và định hướng mở rộng}
...
\subsection{Triển khai PoC: Docker Compose và khả năng chuyển tiếp}
