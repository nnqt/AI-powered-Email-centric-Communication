...
\subsubsection{FR-02 -- Soạn thảo và gửi Email trực tiếp}
...
\subsubsection{FR-03 -- Quản lý trạng thái Email và phản ánh lại máy chủ}
...
\subsubsection{FR-05 -- Cập nhật giao diện tức thời (Real-time UI update)}
...
\subsubsection{FR-06 -- Tự động tạo \& hợp nhất Contact (AI)}
...
\subsubsection{FR-08 -- Gợi ý phản hồi thông minh (Smart Reply Suggestion)}
